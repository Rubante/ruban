				...
				<div id="server${status.index}" class="panel-collapse collapse in">
					<div class="panel-body">
						<table class="table pc">
							...
							<tbody>
								<c:forEach items="${item.stats}" var="value" varStatus="subItem">
						...
						<table class="table phone">
							...
							<tbody>
								<c:forEach items="${item.stats}" var="value" varStatus="subItem">
									<tr>
										<td style="word-break:break-all;">${value.key}(<s:message code="${value.key}" text=""></s:message>)</td>
										<td>
											<c:choose>
												<c:when test="${value.key=='time'}">
