package com.ruban.rbac.backend.group;
...
public class GroupController extends BackendController {
     ...
     * @return
     */
    @RequestMapping(value = "/group/getDptTree", method = RequestMethod.POST)
    @ResponseBody
    @Override
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/group/batchDelete", method = RequestMethod.POST)
