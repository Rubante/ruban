var menu = {
	'home': {
		...
		menu: [{
			title: '首页',
			icon: '${app.basePath}/static/imgs/main/l03.png',
			href: 'index.html',
			isCurrent: true
		}]
	},
	...
	'project': {
		...
		menu: [{
			title: '个人信息',
			icon: '${app.basePath}/static/imgs/main/l01.png',
	...
	'mange': {
		...
		menu: [{
			title: '组织机构管理',
			icon: '${app.basePath}/static/imgs/main/l17.png',
			isCurrent: true,
			href: '${app.basePath}/rbac/backend/company/main'
		},{
			title: '部门管理',
			icon: '${app.basePath}/static/imgs/main/l31.png',
			href: '${app.basePath}/rbac/backend/department/main'
		},{
			title: '人员管理',
			icon: '${app.basePath}/static/imgs/main/l18.png',
			href: '${app.basePath}/rbac/backend/person/main'
		},{
			title: '人员关系设置',
