<input type="text" name="parentName" onclick="company.selectCompanyParent(event)" value="{{parentName}}" style="width:150px;" rel="{{target_id}}" id="{{target_id}}_parentName" autocomplete="off" />
...
<div class="button current">
	<span class="button-label" rel="{{target_id}}_parentName" onclick="company.clickParentInput(event)">选择</span>
</div>