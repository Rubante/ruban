...
(function(){
	...
	getRealPath = function(path){
		var basePath = '<s:url value="/rbac/backend/permission/" />';
		return basePath + path;
	};
	
    permission.add = function(){
    	
    	var targetId = "#permission_add_form";
    ...
    $('body').on('click', '.sort', function(){
		...
		var success = function(html){
	    	layer.open({
			    ...
			    content: html,
			    yes: function(){
			    	var ids = $("[name=permission_sort_id]");
	...
	permission.delete = function(){
    	// 获取所有选中的ids
    	var ids = getSelections("permission_checkbox","permission_id");
    ...
    // 修改权限信息
    permission.update = function(id){

		var success = function(html){
			
			var target_id = "#permission_update_form";
    ...
    // 删除权限
    permission.deleteSingle = function(id){
    	var data = {"id":id};
		// 成功回调
    	var success = function(data){
    		msgAlert(data);
