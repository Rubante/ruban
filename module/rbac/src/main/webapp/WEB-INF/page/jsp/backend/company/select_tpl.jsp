...
<div style="white-space: nowrap;">
	<input type="text" name="companyName" onclick="companyDownTree.select(event)" value="${result.companyName}" style="width:150px;" rel="company" relType="relType" id="companyName" autocomplete="off" <c:if test="${result.companyId != null && result.companyId != 0}">check="notNull"</c:if>  />
