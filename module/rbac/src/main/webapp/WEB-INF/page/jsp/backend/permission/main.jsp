...
<body>
    <div class="container">
        <div id="inner-hd">
            <div class="crumbs">
				...
				<a href="javascript:;" class="crumbs-label">权限管理</a>
			</div>
        </div>

        <div id="inner-bd">
        	<jsp:include page="/WEB-INF/page/jsp/backend/tabbar.jsp">
        		<jsp:param name="page" value="permission"></jsp:param>
        	</jsp:include>
            ...
            <div class="button-group">
		        <div class="button current add" onclick="permission.add();">
		            <i class="iconfont">&#xe620;</i>
		            <span class="button-label">新增权限</span>
		        </div>
		        <div class="button delete" onclick="permission.delete();">
		            <i class="iconfont">&#xe609;</i>
		            <span class="button-label">删除</span>
		        </div>
		    </div>
			
			<div id="permissionListTd">
				<jsp:include page="/WEB-INF/page/jsp/backend/permission/list.jsp"></jsp:include>
			</div>
        </div>
    ...
    <jsp:include page="/WEB-INF/page/jsp/backend/permission/permission_js.jsp"></jsp:include>
