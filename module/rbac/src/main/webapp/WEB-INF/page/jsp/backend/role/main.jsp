...
<head>
	...
	<script type="text/javascript" src='<s:url value="/static/js/lib/ztree/js/jquery.ztree.excheck.min.js" />'></script>
</head> 
<body>
    <div class="container">
        <div id="inner-hd">
        ...
        <div id="inner-bd">
            ...
            <div class="button-group">
		        <div class="button current add" onclick="rubanRole.add()">
		            <i class="iconfont">&#xe620;</i>
		            <span class="button-label">新增角色</span>
		        </div>
		        <div class="button delete"  onclick="rubanRole.delete()">
		            <i class="iconfont">&#xe609;</i>
