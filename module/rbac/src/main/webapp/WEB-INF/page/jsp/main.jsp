...
<head>
	...
	<script type="text/javascript" src='<s:url value="/static/js/main.js" />' ></script>
</head> 
<body>
    <div class="container">
        <div id="pf-hd">
            <div class="pf-logo">
                <img src='<s:url value="/static/imgs/main/logo.png" />' alt="logo">
            ...
            <div class="pf-user">
                <div class="pf-user-photo">
                    <img src='<s:url value="/static/imgs/main/user.png" />' alt="">
                </div>
        ...
        <div id="pf-bd">
            <div id="pf-sider">
                ...
                <ul class="sider-nav">
                     <li class="current">
                        <a href="javascript:;">
                            <img src='<s:url value="/static/imgs/main/l01.png" />'>
                     ...
                     <li>
                        <a href="javascript:;">
                            <img src='<s:url value="/static/imgs/main/l02.png" />'>
                     ...
                     <li>
                        <a href="javascript:;">
                            <img src='<s:url value="/static/imgs/main/l03.png" />'>
                     ...
                     <li>
                        <a href="javascript:;">
                            <img src='<s:url value="/static/imgs/main/l04.png" />'>
                     ...
                     <li>
                        <a href="javascript:;">
                            <img src='<s:url value="/static/imgs/main/l05.png" />'>
                     ...
                     <li>
                        <a href="javascript:;">
                            <img src='<s:url value="/static/imgs/main/l06.png" />'>
