...
(function(){
	...
	getRealPath = function(path){
		var basePath = '<s:url value="/rbac/backend/department/" />';
    ...
    $('body').on('click', '.sort', function(){
		...
		// 查询条件
		var searchData = {"departmentId" : departmentDownTree.getCurrentId()};
		// 数据请求
    ...
    refresh = function(){
		var success = function(data){
			// 刷新部门树
			var treeObj = dptTree.init("dptZtree", eval(data));
